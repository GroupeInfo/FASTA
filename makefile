all : database.o protein.o scorematrix.o threadpool.o query.o main.cpp 
	g++ -Wall -std=c++11 -pthread database.o protein.o threadpool.o scorematrix.o query.o main.cpp -o gotoh
